...
enum SettingsSearchIndex {
    static let all: [SettingsSearchEntry] = [
        ...
        .init(tab: .media, section: "Display", title: "Controls on the Lock Screen", subtitle: "The song, with previous, play and next, at the top of the lock screen. Uses a private part of macOS, so a future version may stop it working.", symbolName: "lock.display"),
